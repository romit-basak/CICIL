...
hallucinations, retrieval-induced errors, and faithfulness improvements ---
while in a blinded two-annotator evaluation across all five languages, the
verified local system is preferred over the retrieval baseline on 82\% of
image pairs (cultural-accuracy $\kappa = 0.79$). We
